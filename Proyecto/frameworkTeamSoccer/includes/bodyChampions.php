...
<div class="col-sm-8">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 ">
            <div id="demo2" class="col-sm-12 carousel slide justify-content-center" data-ride="carousel">
    ...
    <div class="row">
        <div class="col-sm-6 ">
            <div id="demo3" class="col-sm-12 carousel slide justify-content-center" data-ride="carousel">
        ...
        <div class="col-sm-6 ">
            <div id="demo4" class="col-sm-12 carousel slide justify-content-center" data-ride="carousel">
