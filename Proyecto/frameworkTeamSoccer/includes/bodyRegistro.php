                ...
                <div class="card-body">
                    ...
                    <div class="login-form mt-4">
                        <form action="" method="POST">
                            <div class="form-row">
                                <?php if(isset($_POST['submit']) && empty($_POST['nombre_usuario'])) echo "<p style='color:red'>Debes introducir el nombre de usuario"; ?>
                                ...
                                <div class="form-group col-md-12">
                                   ...
                                   <input name="nombre_usuario" placeholder="*Nombre Usuario " class="form-control" type="text" value='<?php if(isset($_POST['submit']) && $_POST['nombre_usuario']!=null) echo $_POST['nombre_usuario'] ; ?>'>
                                    ...
                                    <?php if(isset($_POST['submit']) && empty($_POST['email'])) echo "<p style='color:red'>Debes introducir el email"; ?>
                                ...
                                if(isset($_POST['submit']) && empty($_POST['password1'])){
                                     echo "<p style='color:red'>Debes introducir la contraseña";
                                }else{
                                    
                                    if(isset($_POST['submit']) && ($_POST['password1']!=$_POST['password2'])){
                                        echo "<p style='color:red'>Las contraseñas deben coincidir";
                                        ?>
                                ...
                                <?php if(isset($_POST['submit']) && empty($_POST['nombre'])) echo "<p style='color:red'>Debes introducir el nombre"; ?>
                                ...
                                <?php if(isset($_POST['submit']) && empty($_POST['apellido1'])) echo "<p style='color:red'>Debes introducir el 1er Apellido"; ?>
                                ...
                                <?php if(isset($_POST['submit']) && empty($_POST['fecha_nacimiento'])) echo "<p style='color:red'>Debes introducir una fecha de nacimiento"; ?>
                                <br>
                                ...
                                <?php if(isset($_POST['submit']) && empty($_POST['pais'])) echo "<p style='color:red'>Debes introducir un Pais"; ?>
                                ...
                                <?php if(isset($_POST['submit']) && empty($_POST['codigo_postal'])) echo "<p style='color:red'>Debes introducir el codigo_postal"; ?>
                                ...
                                <?php if(isset($_POST['submit']) && empty($_POST['telefono'])) echo "<p style='color:red'>Debes introducir el telefono"; ?>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                 <?php if(isset($_POST['submit']) && (!isset($_POST['terminos']))) echo "<p style='color:red'>Debes aceptar los terminos"; ?>
